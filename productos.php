...
<body>
    ...
    <div class="container latest-product padd-80">
        ...
        <div class="col-md-3 col-sm-12 mt-30">
            <div id="MainMenu">
                <div class="filters">
                    <?php
                    if (isset($_GET['categ'])) { ?>
                        ...
                        ?>
                            <span>
                                <a href="productos.php?pagina=1&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];}?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"
                        ...
                        <?php
                            ...
                            <span>
                                <a href="productos.php?pagina=1<?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['categ']; ?></i>
                                </a>
                            </span>
                        <?php } ?>
                    ...
                    if (isset($_GET['marca'])) { ?>
                        ...
                        ?>
                            <span>
                                <a href="productos.php?pagina=1&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];}?><?php if (isset($_GET['categ'])){echo "&categ=". $_GET['categ'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"
                                                                        ><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['marca']; ?></i>
                                </a>
                            </span>
                        <?php
                        } else {   ?>
                            <span>
                                <a href="productos.php?pagina=1<?php if (isset($_GET['categ'])){echo "&categ=". $_GET['categ'];}?> <?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['marca']; ?></i>
                                </a>
                            </span>
                        <?php } ?>
                    ...
                    if (isset($_GET['precioMin'])) { ?>
                        ...
                        ?>
                            <span>
                                <a href="productos.php?pagina=1&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];}?><?php if (isset($_GET['categ'])){echo "&categ=". $_GET['categ'];}?><?php if(isset($_GET['marca'])){echo "&marca=". $_GET['marca'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"
                                                                        ><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['precioMin']; ?></i>
                                </a>
                            </span>
                        <?php
                        } else {   ?>
                            <span>
                                <a href="productos.php?pagina=1<?php if (isset($_GET['categ'])){echo "&categ=". $_GET['categ'];}?> <?php if(isset($_GET['marca'])){echo "&marca=". $_GET['marca'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['precioMin']; ?></i>
                                </a>
                            </span>
                        <?php } ?>
                    ...
                    if (isset($_GET['precioMax'])) { ?>
                        ...
                        ?>
                            <span>
                                <a href="productos.php?pagina=1&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];}?><?php if (isset($_GET['categ'])){echo "&categ=". $_GET['categ'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['marca'])){echo "&marca=" . $_GET['marca'];}?>"
                                                                        ><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['precioMax']; ?></i>
                                </a>
                            </span>
                        ...
                        <?php
                            ...
                            <span>
                                <a href="productos.php?pagina=1<?php if (isset($_GET['categ'])){echo "&categ=". $_GET['categ'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['marca'])){echo "&marca=" . $_GET['marca'];}?>"><i class="fa fa-times" aria-hidden="true">
                                        <?php echo $_GET['precioMax']; ?></i>
                                </a>
                            </span>
                        <?php } ?>
                ...
                <div class="list-group panel filter-categories">
                    ...
                    $checkMarca = 0;
                        ...
                        $filterPrecioMin = 0;
                        $filterPrecioMax = 0;
                        //verificar marca, precio
                        if (isset($_GET['marca'])){
                            $checkMarca = 1;
                            $filterMarca = $_GET['marca'];
                        }
                        if (isset($_GET['precioMin'])){
                            $checkPrecioMin = 1;
                            $filterPrecioMin = $_GET['precioMin'];
                        }
                        if (isset($_GET['precioMax'])){
                            $checkPrecioMax = 1;
                            $filterPrecioMax = $_GET['precioMax'];
                        }
                    ...
                    if (isset($_POST['search']) or isset($_GET['search'])) {
                       ...
                       /* WHERE p.product_name LIKE '%" . $searchFilter . "%'*/
                        AND (p.product_name LIKE '%" . $searchFilter . "%' or p.product_code  LIKE '%" . $searchFilter . "%')
                        AND (m.name='$filterMarca' || '$filterMarca' = '')  
                        AND ((p.selling_price >= $filterPrecioMin || $filterPrecioMin = 0 ) && (p.selling_price <= $filterPrecioMax || $filterPrecioMax = 0 ))
                        AND p.status='1'";


                        $categoriasFilter = mysqli_query($con, $query);
                    ...
                    if ($numResults > 0) {
                    while ($row_fam = mysqli_fetch_array($sql_familia)) {
                        /* echo '<script>console.log(' . json_encode($row_fam) . ')</script>'; */
                        $cod_familia = $row_fam["cod_familia"];
                            ...
                            ?>
                                <span>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                                    <a class="list-group-item" href="productos.php?pagina=1&categ=<?php echo $row_categ["name"]; ?>&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];} ?><?php if (isset($_GET['marca'])) {echo "&marca=" . $_GET['marca'] ;}?><?php if (isset($_GET['precioMin'])) {echo "&precioMin=" . $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])) {echo "&precioMax=" . $_GET['precioMax'] ;}?>"><?php echo $row_categ["name"]; ?> </a>
                                                <?php
                                                } else {   ?>
                                                     <a class="list-group-item" href="productos.php?pagina=1&categ=<?php echo $row_categ["name"]; ?>&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];} ?><?php if (isset($_GET['marca'])) {echo "&marca=" . $_GET['marca'] ;}?><?php if (isset($_GET['precioMin'])) {echo "&precioMin=" . $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])) {echo "&precioMax=" . $_GET['precioMax'] ;}?>"><?php echo $row_categ["name"]; ?> </a>
                                                <?php }
                                        ...
                                        <?php
                                            ...
                                            <a class="list-group-item" href="productos.php?pagina=1&categ=<?php echo $row_categ["name"]; ?><?php if (isset($_GET['marca'])) {echo "&marca=" . $_GET['marca'] ;}?><?php if (isset($_GET['precioMin'])) {echo "&precioMin=" . $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])) {echo "&precioMax=" . $_GET['precioMax'] ;}?>">
                                            <?php echo $row_categ["name"]; ?> </a>
                                        <?php } ?>
            ...
            <div id="MainMenuMarca">

                <div class="list-group panel filter-categories">
                    <a class="main-a" href="javascript:void(0)">MARCAS</a>
                    <?php
                    $i = 0;
                    $ids_marcas = "";
                    $checkCategoria = 0;
                    ...
                    WHERE  (p.product_name LIKE '%" . $searchFilter . "%' or p.product_code  LIKE '%" . $searchFilter . "%')
         
                    AND (c.name='$filterCategoria' || '$filterCategoria' = '')
                    AND ((p.selling_price >= $filterPrecioMin || $filterPrecioMin = 0 ) && (p.selling_price <= $filterPrecioMax || $filterPrecioMax = 0 ))
                    AND p.status='1'";

                    $marcasFilter = mysqli_query($con, $query);
                        $numResults = mysqli_num_rows($marcasFilter);
                    } else {
                    $query = "SELECT DISTINCT manufacturer_id 
                    FROM products p
                    ...
                    while ($array_marcas = mysqli_fetch_array($marcasFilter)) {
                        $marca_id =  $array_marcas["manufacturer_id"];

                        $i++;
                        if ($i == $numResults) {
                            $ids_marcas = $ids_marcas . $marca_id;
                        } else if ($i == 1) {
                            $ids_marcas = $marca_id . ",";
                        } else {
                            $ids_marcas = $ids_marcas . $marca_id . ",";
                    ...
                    $sql_marcas = mysqli_query($con, "SELECT *
                    FROM manufacturers 
                    WHERE id IN ($ids_marcas)");
                    if ($numResults > 0) {
                    while ($row_marca = mysqli_fetch_array($sql_marcas)) {
                        // echo '<script>console.log(' . json_encode($row_marca) . ')</script>';
                    ?>
                        <?php if (isset($_POST['search']) or isset($_GET['search'])) {
                        ?>
                            <a class="list-group-item" href="productos.php?pagina=1&marca=<?php echo $row_marca["name"]; ?>&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];} ?><?php if (isset($_GET['categ'])) {echo "&categ=" . $_GET['categ'] ;}?><?php if (isset($_GET['precioMin'])) {echo "&precioMin=" . $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])) {echo "&precioMax=" . $_GET['precioMax'] ;}?>"><?php echo $row_marca["name"]; ?></a>
                              
                        <?php
                        } else {   ?>
                            <a class="list-group-item" href="productos.php?pagina=1&marca=<?php echo $row_marca["name"]; ?><?php if (isset($_GET['categ'])) {echo "&categ=" . $_GET['categ'] ;}?><?php if (isset($_GET['precioMin'])) {echo "&precioMin=" . $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])) {echo "&precioMax=" . $_GET['precioMax'] ;}?>"><?php echo $row_marca["name"]; ?> </a>
                        <?php } ?>
                    <?php }} ?>
                </div>
            </div>
            <div id="MainMenuPrecios">

                <div class="list-group panel filter-categories precios">
                    <a class="main-a" href="javascript:void(0)">PRECIOS</a>
               
                           <input placeholder="Minimo" type="number" min="1" pattern="^[0-9]+" id="precioMin" name="precioMin" autocomplete="off" value="<?php if (isset($_POST['precioMin'])) {
                                                                                                                                                        echo $_POST['precioMin'];
                                                                                                                                                    } else {
                                                                                                                                                        echo $_GET['precioMin'];
                                                                                                                                                    } ?>">
                          ...
                          <input placeholder="Maximo" type="number" min="1" pattern="^[0-9]+" id="precioMax" name="precioMax" autocomplete="off" value="<?php if (isset($_POST['precioMax'])) {
                                                                                                                                                        echo $_POST['precioMax'];
                                                                                                                                                    } else {
                                                                                                                                                        echo $_GET['precioMax'];
                                                                                                                                                    } ?>">
                       ...
                       <div style="text-align:center;">
                                ...
                                ?>
                                        ...
                                        <a class="btn btn-success" id="botonPrecios" role="button" href="productos.php?pagina=1&search=<?php if (isset($_POST['search'])){echo $_POST['search'];} else {echo $_GET['search'];}?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['categ'])){echo "&categ=". $_GET['categ'] ;}?>">BUSCAR</a>
                                

                                <?php
                                } else {   ?>
                               
                                        <a class="btn btn-success" id="botonPrecios" role="button" href="productos.php?pagina=1<?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['categ'])){echo "&categ=". $_GET['categ'] ;}?>">BUSCAR</a>
        ...
        <div class="col-md-9 col-sm-12 mt-30">
            <div class="row">
                ...
                if (isset($_GET['fam'])) {
                    ...
                    AND ((selling_price >= $filterPrecioMin || $filterPrecioMin = 0 ) && (selling_price <= $filterPrecioMax || $filterPrecioMax = 0 ))";
                    ...
                    $end =  (($_GET['pagina'] + $link) < $paginas) ? $_GET['pagina'] + $link : $paginas;
                    $inciar = ($_GET['pagina'] - 1) * $articulos_x_pagina;
                    $query = "SELECT product_id,product_name,buying_price,selling_price,profit,note,image_path,product_code,model
                    FROM products p 
                    INNER JOIN categories c ON (p.category_id=c.id) 
                    INNER JOIN manufacturers m ON (p.manufacturer_id=m.id)                        
                    WHERE p.status='1' 
                    ...
                    AND (m.name='$filterMarca' || '$filterMarca' = '')
                     AND (product_name LIKE '%" . $searchFilter . "%' or product_code  LIKE '%" . $searchFilter . "%')
                    AND ((selling_price >= $filterPrecioMin || $filterPrecioMin = 0 ) && (selling_price <= $filterPrecioMax || $filterPrecioMax = 0 )) order by Orden LIMIT $inciar, $articulos_x_pagina";
                    ...
                    // echo '<script>console.log(' . json_encode($query) . ')</script>';
                    $count_query = mysqli_query($con, $query);
                   /* $count_query = mysqli_query($con, "SELECT count(*) AS numrows FROM products p 
                    INNER JOIN categories c ON (p.category_id=c.id) WHERE p.status='1' AND c.name='$search'");*/
                    if ($row = mysqli_fetch_array($count_query)) {
                        $numrows_cat = $row['numrows'];
                    }
                    $paginas = ceil($numrows_cat / $articulos_x_pagina);
                 ...
                 } else if (isset($_GET['marca']) && (isset($_POST['search']) or isset($_GET['search']))) { //NUEVO FILTRO DE MARCA CON BUSQUEDA
                    //Capturar string de busqueda
            ...
            } else if (isset($_GET['precioMin']) && (isset($_POST['search']) or isset($_GET['search']))) { //NUEVO FILTRO DE MARCA CON BUSQUEDA
                //Capturar string de busqueda
                ...
                $query = "SELECT count(*) AS numrows 
                    ...
                    AND (c.name='$filterCategoria' || '$filterCategoria' = '')
                    AND (product_name LIKE '%" . $searchFilter . "%' or product_code  LIKE '%" . $searchFilter . "%')
                    AND ((selling_price >= $search) && (selling_price <= $filterPrecioMax || $filterPrecioMax = 0 ))";
                $count_query = mysqli_query($con, $query);
                if ($row = mysqli_fetch_array($count_query)) {
                    $numrows_cat = $row['numrows'];
                }
                ...
                $query = "SELECT product_id,product_name,buying_price,selling_price,profit,note,image_path,product_code,model
                    ...
                    AND (c.name='$filterCategoria' || '$filterCategoria' = '')
                    AND (product_name LIKE '%" . $searchFilter . "%' or product_code  LIKE '%" . $searchFilter . "%')
                    AND ((selling_price >= $search) && (selling_price <= $filterPrecioMax || $filterPrecioMax = 0 )) order by Orden LIMIT $inciar, $articulos_x_pagina";
                    $sql_proudcts_all = mysqli_query($con, $query);
            } else if (isset($_GET['precioMin'])) {
                $search = $_GET['precioMin'];
                $checkCategoria = 0;
                $checkMarca = 0;
                $checkPrecioMax = 0;
                ...
                $paginas = ceil($numrows_cat / $articulos_x_pagina);
                // echo '<script>console.log(' . json_encode($paginas) . ')</script>';
            ...
            } else if (isset($_GET['precioMax']) && (isset($_POST['search']) or isset($_GET['search']))) { //NUEVO FILTRO DE MARCA CON BUSQUEDA
                //Capturar string de busqueda
                ...
                $query = "SELECT count(*) AS numrows 
                    ...
                    AND (c.name='$filterCategoria' || '$filterCategoria' = '')
                    AND (product_name LIKE '%" . $searchFilter . "%' or product_code  LIKE '%" . $searchFilter . "%')
                    AND ((selling_price >= $filterPrecioMin || $filterPrecioMin = 0) && (selling_price <= $search ))";
                $count_query = mysqli_query($con, $query);
                if ($row = mysqli_fetch_array($count_query)) {
                    $numrows_cat = $row['numrows'];
                }
                ...
                $query = "SELECT product_id,product_name,buying_price,selling_price,profit,note,image_path,product_code,model
                    ...
                    AND (c.name='$filterCategoria' || '$filterCategoria' = '')
                    AND (product_name LIKE '%" . $searchFilter . "%' or product_code  LIKE '%" . $searchFilter . "%')
                    AND ((selling_price >= $filterPrecioMin || $filterPrecioMin = 0) && (selling_price <= $search )) order by Orden LIMIT $inciar, $articulos_x_pagina";
                    $sql_proudcts_all = mysqli_query($con, $query);
            } else if (isset($_GET['precioMax'])) {
                $search = $_GET['precioMax'];
                $checkCategoria = 0;
                $checkMarca = 0;
                $checkPrecioMin = 0;
               ...
               $count_query = mysqli_query($con, $query);
                ...
                $sql_proudcts_all = mysqli_query($con, $query);
                    ...
                    $sql_proudcts_all = mysqli_query($con, "SELECT product_id,product_name,buying_price,selling_price,profit,note,image_path,product_code,model,stock_min FROM products WHERE status='1'  order by Orden LIMIT $inciar, $articulos_x_pagina");
                }
                ...
                ?>
                                        ...
                                        <form action="">
                                            <div class="detail-row quantity-box">
                                                <div id="field1" class="input--filled" style="padding-left: 20px;">
                                                    <input type="number" name="cantidad" id="cantidad<?php echo $row['product_id']; ?>" min="1" max="10000" step="1" value="1" onchange="validastock2(<?php echo $row['product_id']; ?>)">
                                                    <div class="clearfix"></div>
                                                </div>
                                                <input type="hidden" id="producto<?php echo $row['product_id']; ?>" value="<?php echo $row["product_name"]; ?>">
                                                <input type="hidden" id="precio<?php echo $row['product_id']; ?>" value="<?php if (isset($_SESSION['user_name'])) {
                                                                                                                                echo $row["buying_price"];
                                                                                                                            } else {
                                                                                                                                echo $row["selling_price"];
                                                                                                                            } ?>">
                                                ...
                                                <input type="hidden" id="stock<?php echo $row['product_id']; ?>" value="<?php echo $row['stock_min']; ?>">
                                                <!-- para validar boton de ver modelos de articulos padres.-->
                                                <?php if (substr($row["product_code"],0,1)=="9") 
                                                { ?>
                                                    <a href="" data-toggle="modal" data-target="#quick-modal<?php echo $row['product_id']; ?>">
                                                        <button type="button" id="axgregar<?php echo $row['product_id']; ?>" style="background-color: #1F487E; color: white; width: 120px; height: 50px; border-radius: 16px;">Ver Modelos</button>
                                                    </a>
                                                <?php }else{ ?>
                                                ...
                                                <?php } ?>
                                                <!-- FIN validar boton de ver modelos de articulos padres.-->
                                                <div class="clearfix"></div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <script type="text/javascript">
                            $('#agregar<?php echo $row['product_id']; ?>').click(function() {
                                ...
                                var stock = document.getElementById('stock<?php echo $row['product_id']; ?>').value;

                                var ruta = "prod=" + producto + "&pre=" + precio + "&cant=" + cantidad + "&cod=" + id +
                                    "&pcod=" + product_code + "&model=" + model+ "&stk=" + stock;
                        ...
                        $sql_proudcts_one = mysqli_query($con, "SELECT p.*, c.name categoria,m.name marca FROM products p INNER JOIN categories c ON (p.category_id=c.id) INNER JOIN manufacturers m on m.id=p.manufacturer_id WHERE p.status='1' AND p.product_id='$product_id'");
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-7 detail-right">
                                            ...
                                            <a href=""><?php echo $row2['categoria_padre']; ?></a>      
...
/*                                                 if (isset($_SESSION['user_name'])) {
                                                ...
                                                echo '<span class="item" data-thumb="1"> <a  href="#" onclick= "dataHijos(' .  "'" . $row2['product_id'] .
                                                    "','" . $row2['product_name']  .
                                                    ...
                                                    "','" . $row2['note'] .
                                                    "','" . $row2['stock_min'] .
                                                    "','" . $row2['product_code'] . "'" . ');return false;" >'. $row2['Desc_Categoria']. '</a></span>'; */
                                                    $product_id=$row2["product_id"];
                                                    $sql_hijos = mysqli_query($con, "SELECT h.* , c.name categoria FROM products h INNER JOIN products p ON (h.code_padre=p.product_code) INNER JOIN categories c ON (p.category_id=c.id) WHERE h.status='1' AND p.product_id='$product_id'");

                                                    while ($hijos = mysqli_fetch_array($sql_hijos)) {
                                                        
                                                     //echo '<script>console.log("h:");console.log(' . json_encode($hijos['product_name']) . ');</script>';
                                                    ...
                                                    echo '<span class="item" data-thumb="1"> <a  href="#" onclick= "dataHijos(' .  "'" . $hijos['product_id'] .
                                                        "','" . $hijos['product_name'] .
                                                        "','" . $precio .
                                                        "','" . $precio .
                                                        "','" . $hijos['model'] .
                                                        ...
                                                        "','" . $hijos['note'] .
                                                        "','" . $hijos['stock_min'] .
                                                        "','" . $hijos['product_code'] ."'" . ');return false;" >'. $hijos['Desc_Categoria']. '</a></span>';
                                                }                                                
                                                ?>
                                            </div>
                                                ...
                                                <div class="sub-menu">
                                                    <div class="detail-btm">
                                                        ...
                                                        <form action="">
                                                            <div class="detail-row quantity-box">
                                                                ...
                                                                <div id="field1" class="input--filled">
                                                                    <input type="number" name="cantidad" id="cant<?php echo $row2['product_id']; ?>" min="1" max="10000" step="1" value="1" class="field" onchange="validastock(<?php echo $row2['product_id']; ?>)">
                                                                    <div class="clearfix"></div>
                                                                </div>
                                                                <input type="hidden" id="producto<?php echo $row2['product_id']; ?>" value="<?php echo $row2["product_name"]; ?>">
                                                                <input type="hidden" id="precio<?php echo $row2['product_id']; ?>" value="<?php if (isset($_SESSION['user_name'])) {
                                                                                                                                                echo $row["buying_price"];
                                                                                                                                            } else {
                                                                                                                                                echo $row["selling_price"];
                                                                                                                                            } ?>">
                                                                ...
                                                                <input type="hidden" id="product_code<?php echo $row['product_id']; ?>" value="<?php echo $row["product_code"]; ?>">
                                                                <input type="hidden" id="model<?php echo $row['product_id']; ?>" value="<?php echo $row["model"]; ?>">
                                                                <input type="hidden" id="stk<?php echo $row2['product_id']; ?>" value="<?php echo $row2['stock_min']; ?>">
                                                        ...
                                                        <div class="detail-row">
                                                            <p><span id="codigoSpan<?php echo $row2["product_id"]; ?>">Codigo:</span> <span id="codigoP<?php echo $row2["product_id"]; ?>"><?php echo $row2["product_code"]; ?></span></p>
                                                            <p><span id="codigoSpan2<?php echo $row2["product_id"]; ?>">- Codigo Proveedor:</span> <span id="codigoPV<?php echo $row2["product_id"]; ?>"><?php echo $row2["model"]; ?></span></p>
                                                        </div>
                                                        ...
                                                        <div class="detail-row">
                                                            <p><span id="categoriaSpan<?php echo $row2["product_id"]; ?>">Marca:</span> <span id="categoriaP<?php echo $row2["product_id"]; ?>"><?php echo $row2["marca"]; ?></span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                        ...
                        <script type="text/javascript">
                            $('#add2<?php echo $row2['product_id']; ?>').click(function() {
                                ...
                                var stock = document.getElementById('stk<?php echo $row['product_id']; ?>').value;

                                var ruta = "prod=" + producto2 + "&pre=" + precio2 + "&cant=" + cantidad2 + "&cod=" + id2 +
                                    "&pcod=" + product_code2 + "&model=" + model2 +"&stk="+stock;
                                
                                var productor = document.getElementById('codigoP<?php echo $row['product_id']; ?>').innerHTML;
                                if (productor.substring(0,1)=="9"){
                                    toastr["error"]("Seleccione su Articulo.", "Refermat");
                                }else {
                                    toastr["success"]("Articulo Agregado.", "Refermat");
                    ...
                    <center>
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo $_GET['pagina'] - 1; ?>&categ=<?php echo $_GET['categ']; ?>&search=<?php if (isset($_POST['search'])) {
                                                                                                                                                                            ...
                                                                                                                                                                            echo $_GET['search'];
                                                                                                                                                                        } ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Anterior</a>
                                    </li>
                                <?php
                                } else if (isset($_GET['categ'])) {
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo $_GET['pagina'] - 1; ?>&categ=<?php echo $_GET['categ']; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Anterior</a>
                                    </li>
                                <?php
                                } else if (isset($_POST['search']) or isset($_GET['search'])) {
                                ?>
                                ...
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo $_GET['pagina'] - 1; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Anterior</a>
                                    </li>
                                <?php
                                }
                                if ($start > 1) {
                                ...
                                ?>
                                    <li class="page-item ">
                                        <a class="page-link" href="productos.php?pagina=1&search=<?php if (isset($_POST['search'])) {echo $_POST['search'];} else {echo $_GET['search'];} ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">1</a>
                                    </li>
                                    <li class="disabled">
                                        <span>...</span>
                                    </li>
                                ...
                                ?>
                                         <li class="page-item ">
                                        <a class="page-link" href="productos.php?pagina=1<?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">1</a>
                                    </li>
                                    <li class="disabled">
                                        <span>...</span>
                                    </li>
                                ...
                                for ($i = $start - 1; $i < $end; $i++) {
                                    ...
                                    ?>
                                        <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : ''; ?>">
                                            <a class="page-link" href="productos.php?pagina=<?php echo $i + 1; ?>&categ=<?php echo $_GET['categ']; ?>&search=<?php if (isset($_POST['search'])) {
                                                                                                                                                                    ...
                                                                                                                                                                    echo $_GET['search'];
                                                                                                                                                                } ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"><?php echo $i + 1; ?></a>
                                        </li>
                                    <?php
                                    } else if (isset($_GET['categ'])) {
                                    ?>
                                        <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : ''; ?>">
                                            <a class="page-link" href="productos.php?pagina=<?php echo $i + 1; ?>&categ=<?php echo $_GET['categ']; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"><?php echo $i + 1; ?></a>
                                        </li>
                                    <?php
                                    } else if (isset($_POST['search']) or isset($_GET['search'])) {
                                    ?>
                                    ...
                                    ?>
                                        <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : ''; ?>">
                                            <a class="page-link" href="productos.php?pagina=<?php echo $i + 1; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>"><?php echo $i + 1; ?></a>
                                        </li>
                                    <?php
                                    }
                                }
                                    ...
                                    if (isset($_POST['search']) or isset($_GET['search'])) { ?>
                                        <li class="page-item ">
                                            <a class="page-link" href="productos.php?pagina=<?php echo $paginas; ?>&search=<?php if (isset($_POST['search'])) {
                                                                                                                                ...
                                                                                                                                echo $_GET['search'];
                                                                                                                            } ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?><?php if (isset($_GET['categ'])){echo "&categ=" . $_GET['categ'];}?>"><?php echo $paginas; ?></a>
                                        </li>
                                    <?php } else { ?>
                                        <li class="page-item ">
                                            <a class="page-link" href="productos.php?pagina=<?php echo $paginas; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?><?php if (isset($_GET['categ'])){echo "&categ=" . $_GET['categ'];}?>"><?php echo $paginas; ?></a>
                                        </li>
                                    <?php } ?>
                                ...
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo ($_GET['pagina'] + 1); ?>&search=<?php if (isset($_POST['search'])) {
                                                                                                                                        ...
                                                                                                                                        echo $_GET['search'];
                                                                                                                                    } ?>&categ=<?php echo $_GET['categ']; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Siguiente</a>
                                    </li>
                                <?php
                                ...
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo $_GET['pagina'] + 1; ?>&categ=<?php echo $_GET['categ']; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Siguiente</a>
                                    </li>
                                <?php
                                } else if (isset($_POST['search']) or isset($_GET['search'])) {
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo ($_GET['pagina'] + 1); ?>&search=<?php if (isset($_POST['search'])) {
                                                                                                                                        ...
                                                                                                                                        echo $_GET['search'];
                                                                                                                                    } ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Siguiente</a>
                                    </li>
                                <?php
                                } else {
                                ?>
                                    <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="productos.php?pagina=<?php echo $_GET['pagina'] + 1; ?><?php if (isset($_GET['marca'])){echo "&marca=". $_GET['marca'];}?><?php if(isset($_GET['precioMin'])){echo "&precioMin=". $_GET['precioMin'] ;}?><?php if (isset($_GET['precioMax'])){echo "&precioMax=" . $_GET['precioMax'];}?>">Siguiente</a>
                                    </li>
                                <?php
                                }
                                ?>
    ...
    <script language=JavaScript>
        ...
        function dataHijos(id, nombre, precio1, precio2, model, categoria, img1, img2, img3, video, idPadre, note,stock,codigop) {
            ...
            var stock = 'stock' + idPadre;
            var codigoProveedor = 'codigoPV' + idPadre; 
            ...
            document.getElementById(codigoID).innerHTML = codigop ;
            document.getElementById(codigoProveedor).innerHTML = model;
