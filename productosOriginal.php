            ...
            <div class="bor log">
                ...
                ?>
                    <a href="#">
                        ...
                        <a href="cerrar_sesion.php?url=productos.php"><i class="fa fa-power-off"></i></a>
                    </a>
...
<!--Header-->
<div class="container-fluid checkout-productos"></div>
    ...
    <div class="col-md-12 col-sm-12 mt-30">
        <div class="row">
            ...
            if(isset($_GET['fam'])){
                ...
                $inciar=($_GET['pagina']-1)*$articulos_x_pagina;
                $sql_proudcts_all=mysqli_query($con, "SELECT * FROM products WHERE status='1' AND product_name LIKE '%".$search."%' LIMIT $inciar, $articulos_x_pagina");
                ...
                $inciar=($_GET['pagina']-1)*$articulos_x_pagina;
                $sql_proudcts_all=mysqli_query($con, "SELECT * FROM products WHERE status='1' LIMIT $inciar, $articulos_x_pagina");
            }
            ...
            <div class="col-md-4 col-sm-4 text-left">
                <div class="product">
                    ...
                    <div class="product-body">
                        ...
                        <?php if(isset($_SESSION['user_name'])){ ?>
                        <h4 style="font-size: 16px;">Precio: S/. <?php echo $row["buying_price"]; ?></h4>
                        <h5><?php echo $row["selling_price"]; ?></h5>
                        <?php } else if(!isset($_SESSION['user_name'])){ ?>
                        <h4 style="font-size: 14px;">Precio: S/. ?</h4>
                        <?php }?>
                        <div class="product-body">
                            <form action="">
                                <div class="detail-row quantity-box">
                                    ...
                                    <input type="hidden" id="precio<?php echo $row['product_id']; ?>" value="<?php if(isset($_SESSION['user_name'])){ echo $row["buying_price"];}else{echo $row["selling_price"];} ?>">
                        ...
                        <div class="modal-body">
                                ...
                                <div id="carousel" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="item active" data-thumb="0">
                                            <img src="<?php echo $image_path_2; ?>" alt="" style="width: 300px; height: 400px; cursor:pointer" data-toggle="modal" data-target="#myModal_img<?php echo $row2['product_id']; ?>" >
                                        </div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            ...
                            <div class="col-md-7 detail-right">
                                <div class="detail-top">
                                    ...
                                    <div class="rate">
                                        <?php if(isset($_SESSION['user_name'])){ ?>
                                        <h2>Precio: S/. <?php echo $row2["buying_price"]; ?> <del><?php echo $row2["selling_price"]; ?></del></h2>
                                    ...
                                    <div class="sub-menu">
                                        <div class="detail-btm">
                                            ...
                                            <form action="">
                                                <div class="detail-row quantity-box">
                                                    ...
                                                    <div id="field1" class="input--filled">
                                                        <input type="number" name="cantidad" id="cant<?php echo $row2['product_id']; ?>" min="1" max="10000" step="1" value="1">
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    ...
                                                    <button type="button" id="add<?php echo $row2['product_id']; ?>" style="background-color: #1F487E; color: white; width: 120px; height: 50px; border-radius: 16px;">
                                                        AGREGAR
                                                    </button>
                                                    <div class="clearfix"></div>
                                                </div>
                                            ...
                                            <div class="detail-row">
                                                <p><span>Modelo:</span> <?php echo $row2["model"]; ?></p>
                                            </div>
            ...
            <script type="text/javascript">
            $('#add<?php echo $row2['product_id']; ?>').click(function()
            {
                var producto = document.getElementById('producto<?php echo $row2['product_id']; ?>').value;
                var precio = document.getElementById('precio<?php echo $row2['product_id']; ?>').value;
                var cantidad= document.getElementById('cant<?php echo $row2['product_id']; ?>').value;
                var id= document.getElementById('id<?php echo $row2['product_id']; ?>').value;
    ...
    <div class="col-sm-6 col-md-4" style="text-align: center;">
        <div class="service-body">
            <div class="service-inner">
                ...
                <h3>Por compras mayores a S/. 500, provincias envíar un correo</h3>
            </div>
        </div>
    </div>
